...
public class AipImageClassifyCilent {
    ...
    private static class SingletonInstance {
        //设置APPID/AK/SK
        public static final String APP_ID = "17340855";
        public static final String API_KEY = "VxsAQEj0IqXzYQP4EdhMep65";
        public static final String SECRET_KEY = "VVZG3lFByluPHwNk4mcF6LkpqEgxoUPv";
