...
public final class ResourceUtil {
    ...
    public static Drawable getDrawable(@DrawableRes int id) {
        return ContextCompat.getDrawable(GarbageSortApplication.Companion.getContext(), id);
    }
    ...
    public static int getIdByName(String name) {
        return GarbageSortApplication.Companion.getContext().getResources().getIdentifier(name, "id", GarbageSortApplication.Companion.getContext().getPackageName());
    }
    ...
    public static int getStringIdByName(String name) {
        return GarbageSortApplication.Companion.getContext().getResources().getIdentifier(name, "string", GarbageSortApplication.Companion.getContext().getPackageName());
    }
    ...
    public static int getColorIdByName(String name) {
        return GarbageSortApplication.Companion.getContext().getResources().getIdentifier(name, "color", GarbageSortApplication.Companion.getContext().getPackageName());
    }
    ...
    public static int getDimenIdByName(String name) {
        return GarbageSortApplication.Companion.getContext().getResources().getIdentifier(name, "dimen", GarbageSortApplication.Companion.getContext().getPackageName());
    }
    ...
    public static int getDrawableIdByName(String name) {
        return GarbageSortApplication.Companion.getContext().getResources().getIdentifier(name, "drawable", GarbageSortApplication.Companion.getContext().getPackageName());
    }
    ...
    public static int getMipmapIdByName(String name) {
        return GarbageSortApplication.Companion.getContext().getResources().getIdentifier(name, "mipmap", GarbageSortApplication.Companion.getContext().getPackageName());
    }
    ...
    public static int getLayoutIdByName(String name) {
        return GarbageSortApplication.Companion.getContext().getResources().getIdentifier(name, "layout", GarbageSortApplication.Companion.getContext().getPackageName());
    }
    ...
    public static int getStyleIdByName(String name) {
        return GarbageSortApplication.Companion.getContext().getResources().getIdentifier(name, "style", GarbageSortApplication.Companion.getContext().getPackageName());
    }
    ...
    public static int getAnimIdByName(String name) {
        return GarbageSortApplication.Companion.getContext().getResources().getIdentifier(name, "anim", GarbageSortApplication.Companion.getContext().getPackageName());
    }
    ...
    public static int getMenuIdByName(String name) {
        return GarbageSortApplication.Companion.getContext().getResources().getIdentifier(name, "menu", GarbageSortApplication.Companion.getContext().getPackageName());
    }
    ...
    public static boolean copyFileFromAssets(final String assetsFilePath, final String destFilePath) {
        boolean res = true;
        try {
            String[] assets = GarbageSortApplication.Companion.getContext().getAssets().list(assetsFilePath);
            if (assets != null && assets.length > 0) {
                ...
                res = writeFileFromIS(
                        destFilePath,
                        GarbageSortApplication.Companion.getContext().getAssets().open(assetsFilePath),
                        false
                );
            }
        } catch (IOException e) {
    ...
    public static String readAssets2String(final String assetsFilePath, final String charsetName) {
        InputStream is;
        try {
            is = Objects.requireNonNull(GarbageSortApplication.Companion.getContext()).getAssets().open(assetsFilePath);
        } catch (IOException e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static List<String> readAssets2List(final String assetsPath,
        ...
        try {
            return is2List(GarbageSortApplication.Companion.getContext().getResources().getAssets().open(assetsPath), charsetName);
        } catch (IOException e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static boolean copyFileFromRaw(@RawRes final int resId, final String destFilePath) {
        return writeFileFromIS(
                destFilePath,
                GarbageSortApplication.Companion.getContext().getResources().openRawResource(resId),
                false
        );
    }
    ...
    public static String readRaw2String(@RawRes final int resId, final String charsetName) {
        InputStream is = GarbageSortApplication.Companion.getContext().getResources().openRawResource(resId);
        byte[] bytes = is2Bytes(is);
        if (bytes == null) return null;
        if (isSpace(charsetName)) {
            return new String(bytes);
    ...
    public static List<String> readRaw2List(@RawRes final int resId,
                                            final String charsetName) {
        return is2List(GarbageSortApplication.Companion.getContext().getResources().openRawResource(resId), charsetName);
    }
